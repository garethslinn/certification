quiz.answers = [
  {
    id: 1,
    ans: [
      'Backend is related to servers and server side languages and frontend is related to client side technologies such as Javascript and CSS',
      'Backend is related to previous technologies and frontend is based on modern technologies',
    ...
    ans: [
      ...
      'A script based styling language',
    ...
    ans: [
      ...
      'A programming language to help people with disabilities use code',
    ...
    ans: [
      ...
      'SQL sequences query data and makes it readable to the user',
    ...
    ans: [
      ...
      'Part of the web standards, its emcompasses a responsibile approach to buil',
      '',
      ''
    ],
    id: 14,
